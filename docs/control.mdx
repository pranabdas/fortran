...
<CodeBlock className="fortran" title="src/06_multi_way_if.f90">{multi_way_if}</CodeBlock>
...
<CodeBlock className="fortran" title="src/06_select_case.f90">{select_case}</CodeBlock>
