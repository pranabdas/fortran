...
<CodeBlock language="fortran" title="src/12_add_module.f90">{add_module}</CodeBlock>

Now write our program:

import add from '!!raw-loader!/src/12_add.f90';

<CodeBlock language="fortran" title="src/12_add.f90">{add}</CodeBlock>
...
<CodeBlock language="fortran" title="src/13_function_module.f90">{function_module}</CodeBlock>

import function_table from '!!raw-loader!/src/13_function_table.f90';

<CodeBlock language="fortran" title="src/13_function_table.f90">{function_table}</CodeBlock>
