...
INTEGER
1, 2, 4, 8<sup>†</sup>, 16<sup>†</sup>, default: 4<sup>‡</sup>

LOGICAL
1, 2, 4, 8<sup>†</sup>, 16<sup>†</sup>, default: 4<sup>‡</sup>

REAL
4, 8, 10<sup>†</sup>, 16<sup>†</sup>, default: 4<sup>§</sup>

COMPLEX
4, 8, 10<sup>†</sup>, 16<sup>†</sup>, default: 4<sup>§</sup>

DOUBLE PRECISION
4, 8, 10<sup>†</sup>, 16<sup>†</sup>, default: 8<sup>§</sup>
...
! tab separator, second number will be printed in the position 10-13
PRINT "(i4, t10, i4)", 3, 5
```
