...
<CodeBlock language="fortran" title="src/01_add.f90">{add}</CodeBlock>
...
<CodeBlock language="fortran" title="src/02_cm2inch.f90">{cm2inch}</CodeBlock>

Calculate the circumference of a circle given the diameter:

import circ from '!!raw-loader!/src/03_circ.f90';

<CodeBlock language="fortran" title="src/03_circ.f90">{circ}</CodeBlock>

Formatting output:

import format from '!!raw-loader!/src/04_format.f90';

<CodeBlock language="fortran" title="src/04_format.f90">{format}</CodeBlock>
