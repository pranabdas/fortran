...
<CodeBlock language="fortran" title="src/10_trapezoid.f90">{trapezoid}</CodeBlock>
...
<CodeBlock language="fortran" title="src/14_integration_module.f90">{integration_module}</CodeBlock>

import integration from '!!raw-loader!/src/14_integration.f90';

<CodeBlock language="fortran" title="src/14_integration.f90">{integration}</CodeBlock>
