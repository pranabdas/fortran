...
<CodeBlock language="fortran" title="src/10_trapezoid.f90" showLineNumbers>{trapezoid}</CodeBlock>
...
<CodeBlock language="fortran" title="src/14_integration_module.f90" showLineNumbers>{integration_module}</CodeBlock>

import integration from '!!raw-loader!/src/14_integration.f90';

<CodeBlock language="fortran" title="src/14_integration.f90" showLineNumbers>{integration}</CodeBlock>
